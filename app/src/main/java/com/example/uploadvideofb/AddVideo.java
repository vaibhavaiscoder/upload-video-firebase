...
public class AddVideo extends AppCompatActivity {
    ...
    private void uploadVideo() {
        ...
        StorageReference upload = storageReference.child("myvideos/" + System.currentTimeMillis() + "." + getExtension());
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        upload.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                FileModel obj = new FileModel(title.getText().toString(),uri.toString());
